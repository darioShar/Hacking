...
// get the actual dns server address
...
//	char *dns_server = "8.8.8.8"; //google's server
	char dns_server[20];// = "129.104.32.41"; //X's dns server
//	char *dns_server = "127.0.0.1";

	get_dns_server_ip(dns_server);
	...
	server_v4->sin_port = htons(DEST_PORT);
