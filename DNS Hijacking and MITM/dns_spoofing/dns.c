...
int parse_dns_query(const uint8_t *buf, query *queries,
		res_record *answers, res_record *auth, res_record *addit, int show_output)
{
	//BEGIN_SOLUTION
	dns_header *dns = NULL;
	dns = (dns_header*)buf;
...
int parse_dns_query_fast(const uint8_t *buf, query *queries,
