 ...
 * \param loc_redirect url string in case of redirection.
 * \param max_url_length self_explanatory
 * \param redirected will be set to non 0 if redirection instruction.
 * \return a pointer to the first data byte
 */
char *read_http_reply(struct http_reply *reply, char* loc_redirect, int max_url_length, int* redirected);
